...
})({"kx3Fh":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "ffaa336eb4ecf3fe";
"use strict";
...
},{}],"2mkV0":[function(require,module,exports,__globalThis) {
...
function redirect() {
    if ((0, _userFunctionsJs.getCurrentUser)() != null) {
        const finalURL = new URL(require("f28bc448fa9a8d1a")); // (=> Después de Tarea 11)
...
async function openLoginWindow() {
    ...
    (0, _userFunctionsJs.animacionVentana)("loginWindow", "aparecer");
...
async function openRegisterWindow() {
    ...
    2. Si el target del evento es de contraseñas, comprobar:
        - Que son iguales
        - Que tienen al menos 8 caracteres*/ function checkInput(event) {
        event.target.placeholder = "";
        ...
        if (registerPasswordInput.value.length == 0) textPasswordNotLongEnough.style.display = "none";
        else if (registerPasswordInput.value.length < 8) textPasswordNotLongEnough.style.display = "block";
        else if (registerPasswordConfirmInput.value.length > 0 && registerPasswordInput.value !== registerPasswordConfirmInput.value) textPasswordsDontMatch.style.display = "block";
    }
    // Mostrar ventana poco a poco
    (0, _userFunctionsJs.animacionVentana)("registerWindow", "aparecer");
...
async function login() {
    ...
    if (loginUserInput.value === "") loginUserInput.placeholder = "Este campo no puede estar vac\xedo.";
    if (loginPasswordInput.value === "") loginPasswordInput.placeholder = "Este campo no puede estar vac\xedo.";
    ...
    await (0, _userFunctionsJs.animacionVentana)("loginWindow", "desaparecer");
    redirect();
}
...
async function register() {
    ...
    const textUserAlreadyRegistered = document.getElementById("userAlreadyRegistered");
    // Validación de que los campos no pueden estar vacíos
    if (registerUserInput.value === "") registerUserInput.placeholder = "Este campo no puede estar vac\xedo.";
    if (registerPasswordInput.value === "") registerPasswordInput.placeholder = "Este campo no puede estar vac\xedo.";
    if (registerPasswordConfirmInput.value === "") registerPasswordConfirmInput.placeholder = "Este campo no puede estar vac\xedo.";
    ...
    (0, _userFunctionsJs.setCurrentUser)(username);
    await (0, _userFunctionsJs.animacionVentana)("registerWindow", "desaparecer");
    redirect();
}
// Cerrar ventana
function disposeWindow(event) {
    ...
    if (event.target === loginWindow) (0, _userFunctionsJs.animacionVentana)("loginWindow", "desaparecer");
    if (event.target === registerWindow) (0, _userFunctionsJs.animacionVentana)("registerWindow", "desaparecer");
    // Si se presiona "Esc"
    if (event.key === "Escape") {
        if (loginWindow.style.display !== "none") (0, _userFunctionsJs.animacionVentana)("loginWindow", "desaparecer");
        if (registerWindow.style.display !== "none") (0, _userFunctionsJs.animacionVentana)("registerWindow", "desaparecer");
    }
}
...
},{"./userFunctions.js":"ofUT0","f28bc448fa9a8d1a":"aASqJ"}],"ofUT0":[function(require,module,exports,__globalThis) {
...
},{"eb3a16bc39e01178":"b5hmO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b5hmO":[function(require,module,exports,__globalThis) {
module.exports = require("78f67f9f1bf96ab3").getBundleURL('lWTFQ') + "index.html" + "?" + Date.now();

},{"78f67f9f1bf96ab3":"lgJ39"}],"lgJ39":[function(require,module,exports,__globalThis) {
"use strict";
var bundleURL = {};
...
},{}],"aASqJ":[function(require,module,exports,__globalThis) {
module.exports = require("f0634830057fc6b1").getBundleURL('lWTFQ') + "pages/editor.html" + "?" + Date.now();

},{"f0634830057fc6b1":"lgJ39"}]},["kx3Fh"], null, "parcelRequire94c2")

//# sourceMappingURL=index.b4ecf3fe.js.map
