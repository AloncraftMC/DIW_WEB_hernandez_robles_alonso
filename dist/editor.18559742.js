...
})({"lbq2b":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "f4eb953418559742";
"use strict";
...
},{}],"fX6HN":[function(require,module,exports,__globalThis) {
...
function redirect() {
    if ((0, _userFunctionsJs.getCurrentUser)() == null) {
        const finalURL = new URL(require("8bb73d6c60245ad9")); // (=> Después de Tarea 11)
...
async function openUserWindow() {
    ...
    function checkInput(event) {
        ...
        textPasswordNotLongEnough.style.display = "none";
        textUserAlreadyRegistered.style.display = "none";
        if (changePasswordInput.value.length == 0) textPasswordNotLongEnough.style.display = "none";
        else if (changePasswordInput.value.length < 8) textPasswordNotLongEnough.style.display = "block";
    }
...
async function deleteAccount() {
    document.getElementById("confirmText").style.transform = "scale(3)";
...
// Hacemos visible esto de las ventanas para que pillen el ámbito, yo me entiendo y si no lo buscas en el historial de ChatGPT
...
},{"./userFunctions.js":"13P51","8bb73d6c60245ad9":"efqsK"}],"efqsK":[function(require,module,exports,__globalThis) {
module.exports = require("aa5dd8ff3468b3ea").getBundleURL('l1HGW') + "index.html" + "?" + Date.now();

},{"aa5dd8ff3468b3ea":"lgJ39"}]},["lbq2b","fX6HN"], "fX6HN", "parcelRequire94c2")

//# sourceMappingURL=editor.18559742.js.map
