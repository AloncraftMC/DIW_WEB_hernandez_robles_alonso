...
> [!CAUTION]
> **Parcel** no ha empaquetado los recursos correctamente ya que los métodos asociados a los botones de la interfaz pierden el ámbito y no se reconocen por el navegador, así que para ver funcionar la web, es recomendable o bien usar la propia página alojada en GitHub Pages [https://aloncraftmc.github.io/DIW_WEB_hernandez_robles_alonso/](https://aloncraftmc.github.io/DIW_WEB_hernandez_robles_alonso/) o bien `live-server`, instalable en **Node.js** con `npm install live-server`.
